...
public class UserListView extends JPanel
    ...
    private void addUserListItem(long clientId, String clientName) {
        SwingUtilities.invokeLater(() -> {
            ...
            // Sorting logic will handle layout
    ...
    private void sortUserList() {
        ...
        java.util.List<UserListItem> sortedItems = new java.util.ArrayList<>(userItemsMap.values());
        ...
        glueConstraints.gridy = index;
        glueConstraints.weighty = 1.0;
        glueConstraints.fill = GridBagConstraints.VERTICAL;
        userListArea.add(Box.createVerticalGlue(), glueConstraints);
